# run: scripts/mlp/navierstokes2d_cylinder_flow.sh
# tmux attach: tmux attach -t train_navierstokes2d_cylinder_flow_mlp_{tag}

#!/usr/bin/env bash
set -euo pipefail

MODEL_NAME=mlp
EXPERIMENT_NAME=navierstokes2d_cylinder_flow
TAG=naPINN_test
