...
from pinnlab.utils.ebm import EBM2D, ResidualWeightNet, TrainableLikelihoodGate
...
class Burgers2D(BaseExperiment):
    ...
    def _init_noisy_dataset(self):
        ...
        beta = float(self.noise_cfg.get("floor_scale", 0.005)) 
    ...
    def make_video(self, model, grid_cfg, out_dir, fps=10, filename="flow_evolution_burgers.mp4"):
